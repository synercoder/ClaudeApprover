...
/// <summary>
/// Represents a parsed PowerShell pipeline containing one or more commands linked by operators.
/// </summary>
public class Pipeline
{
    ...
    /// <summary>
    /// Gets or sets the operator linking this pipeline to the next (<c>;</c>, <c>||</c>, <c>&amp;&amp;</c>, or <c>null</c>).
    /// </summary>
    public string? Operator { get; set; } // ";" or "||" or "&&" or null
